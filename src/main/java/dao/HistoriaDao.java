...
public class HistoriaDao implements DaoBase<Historia> {
	...
	public List<Historia> read() {
		...
		try {
			...
			while(rs.next()) {
				...
				historia.setSite(rs.getString("SITE"));
				historia.setFotoPerfil(rs.getString("FOTO_PERFIL"));
				
				//ENDEREÇO				
				Endereco endereco = new Endereco(sql);
				endereco.setLogradouro(rs.getString("ENDERECO"));
				historia.setEndereco(endereco);
			...
			System.out.println("Erro ao listar Historia " + e.getMessage());
			return null;
		}
	...
	@Override
	public Historia read(Historia object) {
		// TODO Auto-generated method stub
		try {
			//Crio a String SQL que vou ler
			String SQL = "SELECT DISTINCT\r\n"
							+ "	TP.ID AS ID_HISTORIA,\r\n"
							+ "	TP.NOME AS NOME_HISTORIA,\r\n"
							+ "	TP.SITE,\r\n"
							+ "	TP.FOTO_PERFIL,\r\n"
							+ "	TP.DESCRICAO AS DESC_HISTORIA,\r\n"
							+ "	TP.NUMERO AS NUM_HISTORIA,\r\n"
							+ "	TP.COMPLEMENTO,\r\n"
							+ "	TH.MELHORDIA,\r\n"
							...
							+ "	TUS.EMAIL\r\n"
						+ "FROM tb_ponto TP\r\n"
							+ "	JOIN tb_historia TH on TH.ID_PONTO = TP.ID \r\n"
							+ "	LEFT JOIN tb_telefone TL ON TL.ID = TP.ID_TELEFONE \r\n"
							+ "	JOIN tb_endereco TE ON TE.ID = TP.ID_ENDERECO \r\n"
			...
			if(rs.next()) {
				Historia historia = new Historia();
				historia.setId(rs.getInt("ID_HISTORIA"));
				historia.setNome(rs.getString("NOME_HISTORIA"));
				historia.setSite(rs.getString("SITE"));
				historia.setFotoPerfil(rs.getString("FOTO_PERFIL"));
				historia.setDescricao(rs.getString("DESC_HISTORIA"));
				historia.setNumero(rs.getInt("NUM_HISTORIA"));
				historia.setComplemento(rs.getString("COMPLEMENTO"));
				historia.setMelhorDia(rs.getString("MELHORDIA"));
				...
				historia.setFaixaPreco(faixaPreco);
				...
				historia.setAvaliacao(avaliacoes);
                ...
                if(rsNumAvaliacao.next()) {
                    historia.setNumAvaliacao(rsNumAvaliacao.getFloat("NUM_AVALIACOES"));
                }   
			...
			ex.printStackTrace();
			System.out.println("HistoriaDao.read=" + ex.getMessage());
		}
		return null;
	}
	...
	@Override
	public void update(Historia object) {
		// TODO Auto-generated method stub
		
	}

	@Override
	public void delete(Historia object) {
		// TODO Auto-generated method stub
