	...
	<article class="container">
		...
		<div class="row">
			...
			<div class="col-md-7 mb-3">
			   ...
			   <%
			    	ArrayList<Avaliacao> listaAvaliacao = Historia.getAvaliacoes();
									    ...
									    <form method="POST" action="avaliacao.do" class="content" autocomplete="off">
								            ...
								            <div class="row mt-3">
								            	<div class="col-md-4 mb-6">
								            		...
								            		<input type="text" class="form-control" id="id-ponto" name="id-ponto" readonly value="<c:out value='${Historia.id}'></c:out>">
								            	</div>
								            	<div class="col-md-8 mb-6">
								            		<label for="nome-ponto">Nome Hotel</label>
								            		<input type="text" class="form-control" id="nome-ponto" name="nome-ponto" readonly value="<c:out value='${Historia.nome}'></c:out>">
								            	</div>
