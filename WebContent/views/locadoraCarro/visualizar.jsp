			...
			<div class="col-md-7 mb-3">
				<div class="card">
					<div class="card-body">
						...
						<div class="row mb-3">
							<div class="col-md-6">
								<h5><p><c:out value="${Locadora.numAvaliacao}"></c:out> 
								avaliações nota <c:out value="${Locadora.mediaAvaliacao}"></c:out> estrelas</h5>
								<div class="card-rate">
			   ...
			   <%
			    	ArrayList<Avaliacao> listaAvaliacao = Locadora.getAvaliacoes();
									    ...
									    <form method="POST" action="avaliacao.do" class="content" autocomplete="off">
								            ...
								            <div class="row mt-3">
								            	<div class="col-md-4 mb-6">
								            		...
								            		<input type="text" class="form-control" id="id-ponto" name="id-ponto" readonly value="<c:out value='${Locadora.id}'></c:out>">
								            	</div>
								            	<div class="col-md-8 mb-6">
								            		<label for="nome-ponto">Nome Hotel</label>
								            		<input type="text" class="form-control" id="nome-ponto" name="nome-ponto" readonly value="<c:out value='${Locadora.nome}'></c:out>">
								            	</div>
