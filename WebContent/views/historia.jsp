...
<%@page import="controller.ListarHistoria"%>
<%@page import="java.util.ArrayList" %>
<%@page import="model.Historia" %>
	...
	<main>
	    ...
	    <article class="container">
			<div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 g-4">
				<%
			    ListarHistoria historia = new ListarHistoria();
			            ArrayList<Historia> lista = historia.listarHistorias();
			    %>			
			   <% for (Historia r: lista) { %>
				   <div class="col d-flex">
				       <div class="card">
				           <a href="../historia.do?id=<%=r.getId() %>">
