...
<%@page import="controller.ListarParque"%>
	...
	<main>
	    ...
	    <article class="container">
			<div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 g-4">
				<%
			    ListarParque parque = new ListarParque();
			            ArrayList<Parque> lista = parque.listarParques();
			    %>			
			   <% for (Parque r: lista) { %>
				   <div class="col d-flex">
				       <div class="card card-d-flex">
				           <a href="../parque.do?id=<%=r.getId() %>">
