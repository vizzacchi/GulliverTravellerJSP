		...
		<div class="row row-cols-1 row-cols-sm-1 row-cols-md-2 row-cols-lg-2">
			<div class="col">
				<div class="card">
					<div class="card-body">
						...
						<p class="mb-3">
							<c:out value="${Parque.descricao }"></c:out>
						</p>
									...
									<div class="modal-body">
										...
										<div class="border p-3 mb-3">
											<div class="row row-cols-1 row-cols-sm-1 row-cols-md-2 row-cols-lg-2 g-4 mb-4">
												<div class="col">
													<h5>
														<c:out value="${Parque.avaliacao.usuario.nome}"></c:out>
													</h5>
												</div>
											...
											<p>
												<c:out value="${Parque.avaliacao.comentario}"></c:out>
											</p>
										</div>
									</div>
			...
			<div class="col">
				...
				<div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-3 g-4 mb-4">
					<div class="col">
						<div class="card">
							<img src="<c:out value="${Parque.fotos.foto}"></c:out>" class="card-img-top" alt="<c:out value="${Parque.fotos.titulo}"></c:out>">
						</div>
					</div>
					<div class="col">
						<div class="card">
