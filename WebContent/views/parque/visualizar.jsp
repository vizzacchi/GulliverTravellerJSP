...
<jsp:useBean id="Parque" scope="session" type="model.Parque"></jsp:useBean>
...
<main>
	   	...
	   	<div class="container">
			<div class="row">
				<div class="col-sm-12 col-md-6">
					<h1 class="fw-bold"><c:out value="${Parque.nome}"></c:out></h1>
				</div>
				<div class="col-sm-12 col-md-6 d-md-flex justify-content-md-end">
					<nav aria-label="breadcrumb">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item"><a href="views/parque.jsp">Parques</a></li>
							<li class="breadcrumb-item active" aria-current="page"><c:out value="${Parque.nome}"></c:out></li>
						</ol>
					</nav>                        
				</div>
			</div>
	...
	<article class="container">
		<div id="photo-gallery" class="mb-3 px-0 py-0">
			<%
		    	ArrayList<Foto> lista = Parque.getFotos();
		    %>			
			<% for (Foto r: lista) { %>
			...
			<div class="col-md-12 mb-3">
				<div class="card">
					<div class="card-body">
						...
						<p><c:out value="${Parque.descricao}"></c:out></p>
					</div>
				</div>
			</div>
			...
			<div class="col-md-7 mb-3">
				<div class="card">
					<div class="card-body">
						...
						<div class="row mb-3">
							<div class="col-md-6">
								<h5><p><c:out value="${Parque.numAvaliacao}"></c:out> 
								avaliações nota <c:out value="${Parque.mediaAvaliacao}"></c:out> estrelas</h5>
								<div class="card-rate">
			   ...
			   <%
			    	ArrayList<Avaliacao> listaAvaliacao = Parque.getAvaliacoes();
									    ...
									    <form method="POST" action="avaliacao.do" class="content" autocomplete="off">
								            ...
								            <div class="row mt-3">
								            	<div class="col-md-4 mb-6">
								            		...
								            		<input type="text" class="form-control" id="id-ponto" name="id-ponto" readonly value="<c:out value='${Parque.id}'></c:out>">
								            	</div>
								            	<div class="col-md-8 mb-6">
								            		<label for="nome-ponto">Nome Hotel</label>
								            		<input type="text" class="form-control" id="nome-ponto" name="nome-ponto" readonly value="<c:out value='${Parque.nome}'></c:out>">
								            	</div>
						...
						<table class="table">
							<tbody>
								<tr>
									...
									<td class="text-end">
										<c:out value="${Parque.telefone}"></c:out>
									</td>
								</tr>
								<tr>
									<td class="fw-bold text-nowrap"><i class="bi bi-display mx-2"></i> Site</td>
									<td class="text-end"><a href= "<c:out value="${Parque.site}"></c:out>" target="_black"><c:out value="${Parque.site}"></c:out></a></td>
								</tr>
								<tr>
									<td class="fw-bold text-nowrap"><i class="bi bi-calendar-event mx-2"></i>Melhor Dia</td>
									<td class="text-end"><c:out value="${Parque.melhorDia}"></c:out></a></td>
								</tr>
							</tbody>
						</table>
					</div>
...
<script>geolocation("<c:out value='${Parque.endereco.tipoLogradouro}'></c:out><c:out value='${Parque.endereco}'></c:out>,<c:out value='${Parque.numero}'></c:out><c:out value='${Parque.endereco.bairro}'></c:out> CEP: <c:out value='${Parque.endereco.cep}'></c:out>");</script>