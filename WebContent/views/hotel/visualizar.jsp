			...
			<section class="mb-4">
				...
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item"><a href="./views/home.jsp">Destino</a></li>
						<li class="breadcrumb-item"><a href="./views/hotel.jsp">Hospedagem</a></li>
						<li class="breadcrumb-item active" aria-current="page">Blue Tree Premium Morumbi</li>
					</ol>
				</nav>
			</section>
			<article class="row row-cols-1 row-cols-sm-1 row-cols-md-2 row-cols-lg-2">
				<div class="col">
