...
<main>
	...
	<article class="container">
		<div id="photo-gallery" class="mb-3 px-0 py-0">
			<%
		    	ArrayList<Foto> lista = Entretenimento.getFotos();
		    %>			
			<% for (Foto r: lista) { %>
			...
			<div class="col-md-12 mb-3">
				<div class="card">
					<div class="card-body">
						...
						<p><c:out value="${Entretenimento.descricao}"></c:out></p>
					</div>
				</div>
			</div>
			...
			<div class="col-md-7 mb-3">
				<div class="card">
					<div class="card-body">
						...
						<div class="row mb-3">
							<div class="col-md-6">
								<h5><p><c:out value="${Entretenimento.numAvaliacao}"></c:out> 
								avaliações nota <c:out value="${Entretenimento.mediaAvaliacao}"></c:out> estrelas</h5>
								<div class="card-rate">
									    ...
									    <form method="POST" action="avaliacao.do" class="content" autocomplete="off">
								            ...
								            <div class="row mt-3">
								            	<div class="col-md-4 mb-6">
								            		...
								            		<input type="text" class="form-control" id="id-ponto" name="id-ponto" readonly value="<c:out value='${Entretenimento.id}'></c:out>">
								            	</div>
								            	<div class="col-md-8 mb-6">
								            		<label for="nome-ponto">Nome Ponto Turístico</label>
								            		<input type="text" class="form-control" id="nome-ponto" name="nome-ponto" readonly value="<c:out value='${Entretenimento.nome}'></c:out>">
								            	</div>
