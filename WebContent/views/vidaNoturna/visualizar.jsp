		...
		<div class="row row-cols-1 row-cols-sm-1 row-cols-md-2 row-cols-lg-2">
			<div class="col">
				<div class="card">
					<div class="card-body">
						...
						<p class="mb-3">
							<c:out value="${VidaNoturna.descricao }"></c:out>
						</p>
						...
						<table class="table">
							<tbody>
								...
								<tr>
									...
									<td class="text-end"><c:out value="${VidaNoturna.regiao}"></c:out></a></td>
								</tr>							
								<tr>
									<td class="fw-bold text-nowrap"><i class="bi bi-currency-dollar mx-2"></i>Preço</td>
									<td class="text-end"><c:out value="${VidaNoturna.faixaPreco.descricao}"></c:out></a></td>
								</tr>						
								<tr>
									<td class="fw-bold text-nowrap"><i class="bi bi-clock mx-2"></i>Horário</td>
									<td class="text-end"><c:out value="${VidaNoturna.horarioFuncionamento.dia} ${VidaNoturna.horarioFuncionamento.abre} ${VidaNoturna.horarioFuncionamento.fecha}"></c:out></a></td>
								</tr>
							</tbody>
						</table>
			...
			<div class="col">
				...
				<div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-3 g-4 mb-4">
					<div class="col">
						<div class="card">
							<img src="<c:out value="${VidaNoturna.fotos.foto}"></c:out>" class="card-img-top" alt="<c:out value="${VidaNoturna.fotos.titulo}"></c:out>">
						</div>
					</div>
					<div class="col">
						<div class="card">
							<img src="./assets/images/vida_noturna/Bar_brahma/foto1.jpg" class="card-img-top" alt="blue tree premium morumbi area de lazer">
						</div>
					</div>
					<div class="col">
						<div class="card">
