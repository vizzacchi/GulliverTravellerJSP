...
<jsp:useBean id="Cultura" scope="session" type="model.Cultura"></jsp:useBean>
...
<main>
	   	...
	   	<div class="container">
			<div class="row">
				<div class="col-sm-12 col-md-6">
					<h1 class="fw-bold"><c:out value="${Cultura.nome}"></c:out></h1>
				</div>
				<div class="col-sm-12 col-md-6 d-md-flex justify-content-md-end">
					<nav aria-label="breadcrumb">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item"><a href="views/cultura.jsp">Cultura</a></li>
							<li class="breadcrumb-item active" aria-current="page"><c:out value="${Cultura.nome}"></c:out></li>
						</ol>
					</nav>                        
				</div>
			</div>
	...
	<article class="container">
		<div id="photo-gallery" class="mb-3 px-0 py-0">
			<%
		    	ArrayList<Foto> lista = Cultura.getFotos();
		    %>			
			<% for (Foto r: lista) { %>
			...
			<div class="col-md-12 mb-3">
				<div class="card">
					<div class="card-body">
						...
						<p><c:out value="${Cultura.descricao}"></c:out></p>
					</div>
				</div>
			</div>
			...
			<div class="col-md-7 mb-3">
				<div class="card">
					<div class="card-body">
						...
						<div class="row mb-3">
							<div class="col-md-6">
								<h5><p><c:out value="${Cultura.numAvaliacao}"></c:out> 
								avaliações nota <c:out value="${Cultura.mediaAvaliacao}"></c:out> estrelas</h5>
								<div class="card-rate">
				...
				<%
			    	ArrayList<Avaliacao> listaAvaliacao = Cultura.getAvaliacoes();
			   ...
			   <% for (Avaliacao r: listaAvaliacao) { %>
							...
							<% } %>
									...
									<% } %>
										<button type="button" id="fechar" name="fechar" class="btn btn-secondary" data-bs-dismiss="modal">Fechar</button>
									</div>
								</div>
							</div>
						</div>
									    ...
									    <form method="POST" action="avaliacao.do" class="content" autocomplete="off">
								            ...
								            <div class="row mt-3">
								            	<div class="col-md-4 mb-6">
								            		<label for="id-ponto">Cod. Ponto</label>
								            		<input type="text" class="form-control" id="id-ponto" name="id-ponto" readonly value="<c:out value='${Cultura.id}'></c:out>">
								            	</div>
								            	<div class="col-md-8 mb-6">
								            		<label for="nome-ponto">Nome Ponto Turístico</label>
								            		<input type="text" class="form-control" id="nome-ponto" name="nome-ponto" readonly value="<c:out value='${Cultura.nome}'></c:out>">
								            	</div>
						...
						<table class="table">
							<tbody>
								<tr>
									...
									<td class="text-end">
										<c:out value="${Cultura.telefone}"></c:out>
									</td>
								</tr>
								<tr>
									<td class="fw-bold text-nowrap"><i class="bi bi-display mx-2"></i> Site</td>
									<td class="text-end">
										<a href= "<c:out value="${Cultura.site}"></c:out>" target="_black"><c:out value="${Cultura.site}"></c:out></a>
									</td>
								</tr>
		                        <tr>
		                            <td class="fw-bold"><i class="bi bi-currency-dollar mx-2"></i> Faixa de preço</td>
		                            <td class="text-end">
		                            	<c:out value="${Cultura.faixaPreco.descricao}"></c:out>
		                            </td>
		                        </tr>
							</tbody>
						</table>
...
<script>geolocation("<c:out value='${Cultura.endereco.tipoLogradouro}'></c:out><c:out value='${Cultura.endereco}'></c:out>,<c:out value='${Cultura.numero}'></c:out><c:out value='${Cultura.endereco.bairro}'></c:out> CEP: <c:out value='${Cultura.endereco.cep}'></c:out>");</script>