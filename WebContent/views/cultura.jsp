		...
		<div class="row row-cols-1 row-cols-sm-1 row-cols-md-2 row-cols-lg-2">
			<div class="col">
				<div class="card">
					<div class="card-body">
						...
						<p class="mb-3">
							<c:out value="${Cultura.descricao }"></c:out>
						</p>
									...
									<div class="modal-body">
										...
										<div class="border p-3 mb-3">
											<div class="row row-cols-1 row-cols-sm-1 row-cols-md-2 row-cols-lg-2 g-4 mb-4">
												<div class="col">
													<h5>
														<c:out value="${Cultura.avaliacao.usuario.nome}"></c:out>
													</h5>
												</div>
											...
											<p>
												<c:out value="${Cultura.avaliacao.comentario}"></c:out>
											</p>
										</div>
									</div>
						...
						<table class="table">
							<tbody>
								...
								<tr>
									...
									<td class="text-end"><a href= "<c:out value="${Cultura.site}"></c:out>" target="_black"><c:out value="${Cultura.site}"></c:out></a></td>
								</tr>
								<tr>
									<td class="fw-bold text-nowrap"><i class="bi bi-calendar-event mx-2"></i>Melhor Dia</td>
									<td class="text-end"><c:out value="${Cultura.melhorDia}"></c:out></a></td>
								</tr>
							</tbody>
						</table>
			...
			<div class="col">
				...
				<div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-3 g-4 mb-4">
					<div class="col">
						<div class="card">
							<img src="<c:out value="${Cultura.fotos.foto}"></c:out>" class="card-img-top" alt="<c:out value="${Culturas.fotos.titulo}"></c:out>">
						</div>
					</div>
					<div class="col">
						<div class="card">
							<img src="./assets/images/pontos_culturais/mas/masp_rua.jpg" class="card-img-top" alt="masp fachada">
						</div>
					</div>
					<div class="col">
						<div class="card">
							<img src="./assets/images/pontos_culturais/mas/arte_masp.webp" class="card-img-top" alt="quadros de artes no masp">
						</div>
					</div>
				</div>
...
<script>geolocation("<c:out value='${Hotel.endereco.tipoLogradouro}'></c:out><c:out value='${Cultura.endereco}'></c:out>,<c:out value='${Hotel.numero}'></c:out><c:out value='${Hotel.endereco.bairro}'></c:out> CEP: <c:out value='${Hotel.endereco.cep}'></c:out>");</script>